...
class LocalConfigTests(unittest.TestCase):
    ...
    def test_assistant_local_file_preserves_base_weather_units(self) -> None:
        ...
        self.assertEqual(config.personal_data.database_path.name, "sebastian.db")
        self.assertEqual(config.personal_data.search_result_limit, 8)
        self.assertEqual(config.personal_data.spoken_item_limit, 5)
